...
Ball::Ball(float x, float y, color_t color) {
    ...
    this->object[0] = create3DObject(GL_TRIANGLES, 3*6, vertex_buffer_data, COLOR_DARKBLUE, GL_FILL);
    this->object[1] = create3DObject(GL_TRIANGLES, 3*6, vertex_buffer_data2, COLOR_BLUE, GL_FILL);
